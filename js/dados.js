 ...
 */
 ...
 function salvar(event, collection){
    ...
    else if(document.getElementById('cpf').value === '') { alert('⚠ É obrigatório informar o seu cpf!')}
    else if(document.getElementById('cidade').value === '') { alert('⚠ É obrigatório informar o campo cidade!')}
    else if(document.getElementById('endereço').value === '') { alert('⚠ É obrigatório informar o endereço!')}
    else if(document.getElementById('telefone').value === '') { alert('⚠ É obrigatório informar o campo Fone/celular!')}
